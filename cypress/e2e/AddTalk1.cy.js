...
// Enter username and password and click on signin 
    ...
    cy.wait(10000);
    cy.get('h4').contains('3rd Event created by automated script').click();
...
// Function to edit a talk
function editTalk(talkTitle) {
  // Locate the talk in the list based on the title and click on the edit button
  cy.contains('.talk-title', talkTitle)
    .parents('.talk-item')
    .find('.edit-button')
    .click();

  // Put data in new fields or perform any additional edits
  ...
  // Save the changes (assuming there is a save button)
